...
We define the body of a creature using a Morphology object. This object wraps a MultiDirectedGraph \TODO{(we should talk about why we use a multidirected graph, and perhaps how/why we expand it into a Tree)}.  
